...
| `duration_indices` | Int32 | `[n]` | STF duration indices to search |
...
| `duration_idx` | Int32 | `[N_trials]` | STF duration index (1-based) |
...
- All indices (`depth_indices`, `freq_indices`, `duration_indices`, `station_idx`,
  trial axis indices) are 1-based. See Index Convention in `doc/schema.md`.
