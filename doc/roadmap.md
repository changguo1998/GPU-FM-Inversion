...
| `doc/plans/2026-09-18-forward-cuda-design.md` | Forward CUDA 后端设计（独立审阅修订完成，待复审） |
| `doc/plans/2026-09-18-forward-cuda-tasks.md` | Forward CUDA 后端分步实施与验收任务 |
...
| [ ] forward CUDA backend | P1 | 独立审阅修订完成，待复审；保持 OpenMP CPU fallback 与 HDF5 schema 不变 |
