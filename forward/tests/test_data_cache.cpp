...
int main() {
    ...
    // ── Test DataCache ─────────────────────────────────────────────────
    {
        ...
        // synamp layout: [n_syn_phases × 6] column-major = synamp[phase*6+i + j*n_syn_phases]
        // synamp(0, 0) where synamp is [n_phases*6, 6] LayoutLeft
        ...
        // cc layout: [n_phases*cc_pp × 6] column-major: cc[(phase*cc_pp+lag) + comp*(n_phases*cc_pp)]
        // n_phases_cc = 2, cc_pp = 11
        ...
        // amp_P layout: [n_phases × 6 × 6] column-major: amp[phase + i*n_phases + j*(n_phases*6)]
        // ampP_h(0, 0, 0) = ampP_h[0 + 0*n_phases_psr + 0*(n_phases_psr*6)] = ampP_h[0]
