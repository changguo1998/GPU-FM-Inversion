...
static void write_1d_double_dset(hid_t loc, const char *name,
  ...
  hid_t dset = H5Dcreate(loc, name, H5T_NATIVE_DOUBLE, space, H5P_DEFAULT,
...
static void write_int_scalar(hid_t loc, const char *name, int value) {
  ...
  hid_t dset = H5Dcreate(loc, name, H5T_NATIVE_INT, space, H5P_DEFAULT,
                         H5P_DEFAULT, H5P_DEFAULT);
...
static void write_string_1d(hid_t loc, const char *name,
  ...
  hid_t dset =
      H5Dcreate(loc, name, dtype, space, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
