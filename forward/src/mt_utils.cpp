...
//   m[3] =  sin(2*d)*sin(r)                                                // Mzz
//   m[4] =  cos(2*s)*sin(d)*cos(r) + 0.5 * sin(2*s)*sin(2*d)*sin(r)      // Mxy
//   m[5] = -1 * (cos(s)*cos(d)*cos(r) + sin(s)*cos(2*d)*sin(r))           // Mxz
//   m[6] = -1 * (sin(s)*cos(d)*cos(r) - cos(s)*cos(2*d)*sin(r))           // Myz
