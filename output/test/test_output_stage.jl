...
@testset "Output stage integration" begin
    ...
    run_create_status = @testset "Create test status_2.h5 (converged)" begin
        ...
        h5open(status_path, "w") do f
            ...
            write(sgr, "polarity_channel_mask", strategy.polarity_channel_mask)
            write(sgr, "psr_channel_mask", strategy.psr_channel_mask)
    ...
    @testset "Edge case: single trial" begin
        ...
        h5open(status_path, "w") do f
            ...
            write(sgr, "polarity_channel_mask", Int32[1])
            write(sgr, "psr_channel_mask", Int32[1])
